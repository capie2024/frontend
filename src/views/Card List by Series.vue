                ...
                日期
                        ...
                        <section class="show-card">
                            <a v-for="card in viewedSeries" :key="card.id" href="#" class="transition-colors url" @click.prevent="handleSeries(card.id)" >
                                    ...
                                    <div class="card-text">
                                        <div class="flex">
                                            <svg data-v-09f2b439="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon" class="flex-none icon-size color-a1">
