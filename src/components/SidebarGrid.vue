        ...
        <ul class="sidebar-menu">
            ...
            <li :class="{ 'active': route.path === '/series' }">
                <router-link to="/series" class="w-full h-full">
                    <svg v-if="route.path === '/series'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" aria-hidden="true" data-slot="icon" class="flex-none w-7 h-7"><path d="M16.5 6a3 3 0 0 0-3-3H6a3 3 0 0 0-3 3v7.5a3 3 0 0 0 3 3v-6A4.5 4.5 0 0 1 10.5 6h6Z"></path><path d="M18 7.5a3 3 0 0 1 3 3V18a3 3 0 0 1-3 3h-7.5a3 3 0 0 1-3-3v-7.5a3 3 0 0 1 3-3H18Z"></path></svg>
            ...
            <li :class="{ 'active': route.path === '/deck' }">
                <router-link to="/deck" class="w-full h-full">
                    <svg v-if="route.path === '/deck'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" aria-hidden="true" data-slot="icon" class="flex-none w-7 h-7"><path fill-rule="evenodd" d="M6.32 2.577a49.255 49.255 0 0 1 11.36 0c1.497.174 2.57 1.46 2.57 2.93V21a.75.75 0 0 1-1.085.67L12 18.089l-7.165 3.583A.75.75 0 0 1 3.75 21V5.507c0-1.47 1.073-2.756 2.57-2.93Z" clip-rule="evenodd"></path></svg>
