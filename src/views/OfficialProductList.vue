        ...
        <div class="aa">
            ...
            <div class="all-card">
                ...
                <section class="grid-card" >
                    <a :href="product.link" class="url transition-colors" v-for="(product, index) in products" :key="index">
                        <div>
                            <img v-if="product.cover" :src="product.cover" alt="" class="a-img">
                        </div>
                        <div class="card-text">
                            <div class="flex">
                                ...
                                <p class="color-a1 flex-p"v-if="product.publishAt" >{{ product.publishAt }}</p>
                            </div>
                            <p class="font-size14 color-white padding-bottom" v-if="product.name" >{{ product.name }}</p>
                        </div>
                    </a>
                </section>
            </div>
